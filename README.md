# Dodoi-Engine NGC - version 0.27.1
...
All engine headers are reachable from `src/de-ngc/`. The snippets below are trimmed from the real `src/playground/` example project.
...
A `scene_t` (`de-ngc/gfx/scene.h`) is a plain struct of function pointers plus a `camera_t`. Wire it up once, then drive the loop from your own `run()`:

```c
#include "de-ngc/gfx/scene.h"
#include "de-ngc/gfx/gfx.h"
#include "de-ngc/core/engine.h"
#include "de-ngc/core/context.h"
#include "logo_png.h"
...
### Graphics (`de-ngc/gfx/gfx.h`, `color.h`)
...
### Sound & Music (`de-ngc/sfx/sfx.h`)

```c
#include "de-ngc/sfx/sfx.h"
#include "ok_wav.h"
...
### Camera & Collision (`de-ngc/core/camera.h`, `collision.h`)

```c
#include "de-ngc/core/camera.h"
#include "de-ngc/core/collision.h"
...
### ECS — Entities & Components (`de-ngc/ecs/`)
...
```c
#include "de-ngc/ui/button.h"
#include "de-ngc/ui/label.h"
#include "hand_png.h"
...
### Math (`de-ngc/math/math2d.h`)

```c
#include "de-ngc/math/math2d.h"
